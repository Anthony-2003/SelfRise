    ...
    return Column(
      children: [
        ListTile(
          ...
          onTap: () {
            // Agregar lógica para la opción de Estadísticas
             Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => EditarHabito(initialTabIndex: 0, habito: habito)), // Llama a EditarHabito
            );
          },
        ),
        ListTile(
          ...
          onTap: () {
             Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => EditarHabito(initialTabIndex: 1, habito: habito)), // Llama a EditarHabito
            );
          },
        ),
        ListTile(
// Color de fondo del ListTile
  ...
  void _mostrarDialogoEliminarHabito(BuildContext context,
      Map<String, dynamic> habito, Function closeDialogs) {
    showDialog(
      context: context,
